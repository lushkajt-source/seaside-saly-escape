...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-premium hover:shadow-premium-lg rounded-full",
        ...
        premium: "bg-foreground text-background hover:bg-foreground/90 shadow-premium-lg hover:shadow-premium-xl rounded-full tracking-widest uppercase font-semibold",
        warm: "bg-warm text-accent-foreground hover:bg-warm/90 shadow-premium hover:shadow-premium-lg rounded-full tracking-wide uppercase font-semibold",
      },
      size: {
